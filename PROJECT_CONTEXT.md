...
- Aktuelle Version: **bauplan-v93** (Stand: `CACHE_NAME` in `sw.js`)
...
---
**Letzte Hand-Off (v93):** Tagesansicht fertig (fester 126px-Maßstab, scharf, Mo–So, tag-genaues Drag/Editor/Undo, KW-Raster fluchtet). Header einheitlich Navy. Blower-Door nur in T 5.1. Cron-Fehlermail behoben (User korrigierte `/usr/bin/php` im KIS) + `cleanup.php` CLI-abgesichert. **Nächste sinnvolle Schritte:** User-Accounts, Excel/Raumbuch-Import, Mail-Benachrichtigungen, Gastromatic.
